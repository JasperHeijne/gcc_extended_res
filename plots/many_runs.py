...
method_map = {
    "basic-filter_output.txt": "Basic Filter",
...
def plot_all_metrics_comparison_grid(method_x, method_y, metrics=("time", "decisions", "conflicts", "lbd"), save=True):
    ...
    :param method_y: Name of method for y-axis (e.g., "Basic Filter")
...
plot_all_metrics_comparison_grid("Extended Res", "Basic Filter")
plot_all_metrics_comparison_grid("Extended Res", "Regin")

# Extended Regin comparisons
plot_all_metrics_comparison_grid("Extended Regin", "Basic Filter")
...
# methods: Basic Filter (subst for decomposition), Regin, Extended Res, Extend Regin
